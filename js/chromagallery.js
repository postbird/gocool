                ...
                setTimeout(function()
                {
                    ...
                    ({
                        load: function()
                        {
                            ...
                            {
                                var imgDescription = ($img.attr('alt') !== undefined) ? $img.attr('alt'): "";
            ...
            _createGrid:function()
            {
                ...
                if(this.settings.items)
                {
                    ...
                    for (var i = 0; i < this.settings.items.length; i++)
                    {
                        ...
                        {
                            this.grid.append("<div class='chrg-item chrg-no-select' onclick='showFullImg(this);' style='width:"+columnWidth+"%; margin-bottom:"+this.settings.gridMargin+"px;'>"+
                ...
                else
                {
                    ...
                    this.grid = this.$el.find(".chrg-grid");
                    this.$el.find("img")
                        .wrap("<div class='chrg-item chrg-no-select'  onclick='showFullImg(this);' style='width:"+columnWidth+"%; margin-bottom:"+this.settings.gridMargin+"px;'></div>")
